...
# ===========================================================================
HOST = "pranav"   # shown as  pranav@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "Building InterviewAce - AI interview prep"),
    ("kv", "Learning", "System Design, GenAI, Advanced React"),
    ("kv", "Edu", "Computer Engineering Student"),
    ("kv", "Goal", "Scalable AI-powered software products"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Languages", "Java, Python, C/C++, TypeScript, JS"),
    ("kv", "Web", "React, Node.js, Express, HTML5, PHP"),
    ("kv", "Cloud", "AWS, GCP, Azure, Docker, Vercel"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "AI-powered interview prep platform (InterviewAce)"),
    ("bul", "Open to open-source & hackathon collabs"),
]
